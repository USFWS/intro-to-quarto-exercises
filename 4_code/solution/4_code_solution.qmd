...
```{r}
#| label: fig-site-map
#| fig-cap: "Map of Western Snowy Plover survey locations"
#| output: asis
...
kable(table_data, 
      caption = paste0("Seasonal Western Snowy Plover observational counts at the ", 
                       params$Site, 
                       " survey location."), 
      align = "c")
```
...
```{r}
#| include: true
#| label: fig-obs-per-hour
#| fig-cap: "Mean Monthly Western Snowy Plover observation rates (per hour)."
